<template>
  <el-card>
    ...
    <el-input v-model="setKey" placeholder="key" />
    <el-input v-model="setValue" placeholder="value" @keyup.enter="onSet" />

    <el-button @click="onSet"> set </el-button>

    <el-divider />

    <el-input v-model="getKey" placeholder="key" @keyup.enter="onGet" />
    ...
    <el-input v-model="removeKey" placeholder="key" @keyup.enter="onRemove" />
  ...
  <el-card>
    ...
    <el-input v-model="setKey2" placeholder="key" />
    <el-input v-model="setValue2" placeholder="value" @keyup.enter="onSet2" />

    <el-button @click="onSet2"> set </el-button>

    <el-divider />

    <el-input v-model="getKey2" placeholder="key" @keyup.enter="onGet2" />
    ...
    <el-input v-model="removeKey2" placeholder="key" @keyup.enter="onRemove2" />
